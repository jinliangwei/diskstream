...
public:
  ...
  // [begin,end)
  size_t randDiscrete(const std::vector<double>& distrib, size_t begin, size_t end) {
    double totprob  = 0;
  ...
  static void logprobsToRelprobs(std::vector<double> &distrib, size_t begin, size_t end) {
